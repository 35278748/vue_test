<template>
  <div class="login_container">
    <div class="login_box">
      ...
      <!-- 登录区域 -->
      <el-form ref="loginFormRef" :model="loginForm" :rules="loginFormRules" label-width="0px" class="cus_login_form">
  ...
  methods: {
    ...
    login() {
      this.$refs.loginFormRef.validate(async (valid) => {
        ...
        //   1.1 项目中除了登录之外的其他api接口，必须在登录之后才能说
